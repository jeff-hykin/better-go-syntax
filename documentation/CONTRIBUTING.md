...
- Create a `your_feature.go_simplified` file in the `language_examples/` folder. Once it is created, add code to it that demonstrates your feature (more demonstration the better).
...
```json
{
    ...
    "name": "punctuation.separator.attribute.go_simplified",
    "patterns": [
        {
...
```json
{
    ...
    "beginCaptures": {
        "0": {
            "name": "punctuation.section.attribute.begin.go_simplified"
        }
    },
    "endCaptures": {
        "0": {
            "name": "punctuation.section.attribute.end.go_simplified"
        }
    },
    "name": "support.other.attribute.go_simplified",
    "patterns": [
        {
