...
- Create a `your_feature.go` file in the `language_examples/` folder. Once it is created, add C++ code to it that demonstrates your feature (more demonstration the better).
...
```json
{
    ...
    "name": "punctuation.separator.attribute.go",
    "patterns": [
        {
...
```json
{
    ...
    "beginCaptures": {
        "0": {
            "name": "punctuation.section.attribute.begin.go"
        }
    },
    "endCaptures": {
        "0": {
            "name": "punctuation.section.attribute.end.go"
        }
    },
    "name": "support.other.attribute.go",
    "patterns": [
        {
